...
Intensity_enc.classes_ = np.load('gdrive/My Drive/金融科技Final_project/intensity_categories.npy')

BE_enc = OneHotEncoder(sparse=False)
BE_enc.classes_ = np.load('gdrive/My Drive/金融科技Final_project/BE_categories.npy')

SE_enc = OneHotEncoder(sparse=False)
SE_enc.classes_ = np.load('gdrive/My Drive/金融科技Final_project/SE_categories.npy')
